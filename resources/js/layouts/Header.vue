                    ...
                    <div class="col-lg-6 col-xl-2 col-md-6 col-6">
                        <div class="header-right d-flex justify-content-end">
                            <div class="quote-icon quote-user d-none d-md-block ml--15 ml_sm--5">
                                <router-link class="edu-btn btn-medium left-icon header-button" to="/register"><i class="ri-user-line"></i>Daftar</router-link>
                            </div>
                             <div class="quote-icon quote-user d-none d-md-block ml--15 ml_sm--5">
                                <router-link class="edu-btn btn-medium left-icon header-button" to="/login"><i class="ri-user-line"></i>Admin</router-link>
                            </div>
                        </div>
